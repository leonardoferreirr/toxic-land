...
export default function WhatsAppButton() {
  // Sem número configurado, não renderiza o botão.
  if (!BRAND.whatsapp) return null;

  const msg = encodeURIComponent(`Hi! I came from the ${BRAND.name} site and I have a question.`);
  return (
    <a
      href={`https://wa.me/${BRAND.whatsapp}?text=${msg}`}
      target="_blank"
